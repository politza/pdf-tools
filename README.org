...
** About this package
   ...
   to consider switching to PDF Tools for viewing PDF files.
   ...
   + Smoother Display :: Some care has been taken to get the page you
        ...
        likely going to want to look at in the near future.
   + No image cache directory :: Almost everything happens in memory.
